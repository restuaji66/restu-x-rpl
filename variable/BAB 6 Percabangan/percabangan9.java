...
public class percabangan9 {
    ...
    private static void penentuanAngkaGanjilGenap() {
        // TODO Auto-generated method stub
        throw new UnsupportedOperationException("Unimplemented method 'penentuanAngkaGanjilGenap'");
    }
    ...
    public static void penentuanAngkaTerbesar() {
        ...
        System.out.println("Masukkan angkakedua: ");
    ...
    public static void main(String[] args) {
        ...
        if (num % 2 == 0) {
            ...
            System.out.println("Angka " + num + "adalah genjil.");
        }
    }
}
